pipeline {
    agent any
     environment {
        ...
        ECR_REGISTRY_URL = '854171615125.dkr.ecr.us-west-1.amazonaws.com/ujjwal_repo'
    }
    stages {
        ...
        /*stage('Trigger Deploy') {
            steps {
                ...
                string(name: 'YOLO5_IMAGE_URL', value: "854171615125.dkr.ecr.us-west-1.amazonaws.com/ujjwal_repo:${BUILD_NUMBER}")
                    ]
                }
            }*/
        }  
